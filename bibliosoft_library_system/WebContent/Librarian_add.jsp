						...
						<div class='row-fluid'>
							<div class='span12'>
								<div class='page-header'>
									<h1 class='pull-left'>
										<i class='icon-ok'></i> <span>Add Librarian</span>
									</h1>
									<div class='pull-right'>
										<ul class='breadcrumb'>
											...
											<li class='separator'><i class='icon-angle-right'></i></li>
											<li class='active'>Librarian Add</li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class='span12 box'>
								...
								<div class='box-content'>
									...
									<form class='form form-horizontal validate-form'
										style='margin-bottom: 0;' action="addlibrarian" method="post">
										<div class='control-group'>
											<label class='control-label' for='validation_name'>Account</label>
											<div class='controls'>
												<input data-rule-minlength='6' data-rule-required='true'
													id='account' name='account'
													placeholder='Please input account' type='text' />
											</div>
										</div>
										<div class='control-group'>
