...
<body class='contrast-blue '>
	<pg:pager url="deleterule" maxPageItems = "5" maxIndexPages="10" export="offset,currentPageNumber=pageNumber" isOffset="false"  index="half-full"  > 
	<div id='wrapper'>
						...
						<div class='row-fluid'>
							<div class='span12 box'>
								<div class='box-header blue-background'>
									<div class='title'>Reader Information</div>
									<div class='actions'>
											...
											<table class='table' style='margin-bottom: 0;'>
												...
												<% List<Rule> rules=(List<Rule>)request.getAttribute("rules") ;%>
													<c:forEach items="${rules}" var="Rule"
														...
														<pg:item>
														<tr>
															<td>${Rule.getrule_id()}</td>
															<td>${Rule.getfine()}</td>
															<td>${Rule.getreturn_period()}</td>
															<td>${Rule.getdeposit()}</td>
															<td>

																<form action="editRuleWeb" method="post">
																	<a href="#"><button class="btn btn-default" name="edit_id"
																			value="${Rule.getrule_id()}">Edit</button></a>
																</form>
																<form action="deleterule" method="post">
																	<a href="#"><button class="btn btn-default" name="delete_id"
																			value="${Rule.getrule_id()}">Delete</button></a>
																</form>
															</td>
														</tr>
														 </pg:item>  
