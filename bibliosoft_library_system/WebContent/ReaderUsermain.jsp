...
<div class="col-lg-5  pull-right">
  ...
  <a class="button button-little bg-red" href=ReaderLogin.jsp>Logout</a>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="Displayall.jsp" target="right"><span class="icon-caret-right"></span>Check out Books</a></li>    
  </ul>   
  <h2><span class="icon-user"></span>Personal Settings</h2>
  <ul>
    <li><a href="Person.html" target="right"><span class="icon-caret-right"></span>Personal Information</a></li>
