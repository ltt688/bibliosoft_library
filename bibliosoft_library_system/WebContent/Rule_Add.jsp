...
<body class='contrast-blue '>
						...
						<div class='row-fluid'>
							<div class='span12'>
								<div class='page-header'>
									<h1 class='pull-left'>
										<i class='icon-ok'></i> <span>Add Rule</span>
									</h1>
							...
							<div class='span12 box'>
								...
								<div class='box-content'>
									...
									<form class='form form-horizontal validate-form'
										style='margin-bottom: 0;' action="addrule" method="post">
										<div class='control-group'>
											<label class='control-label' for='validation_name'>Rule ID</label>
											<div class='controls'>
												<input data-rule-minlength='1' data-rule-required='true'
													id='rule_id' name='rule_id'
													placeholder='Please input Rule' type='text' />
											</div>
										</div>
										<div class='control-group'>
											...
											<div class='controls'>
												<input data-rule-minlength='1' data-rule-required='true'
													id='fine' name='fine' placeholder='Please input fine'
													type='text' />
											</div>
										</div>
										<div class='control-group'>
											<label class='control-label' for='validation_name'>Return period</label>
											<div class='controls'>
												<input data-rule-minlength='1' data-rule-required='true'
													id='period' name='period'
													placeholder='Please input phone return_period' type='text' />
											</div>
										</div>
									
										<div class='control-group'>
											<label class='control-label' for='validation_name'>Deposit</label>
											<div class='controls'>
												<input data-rule-minlength='1' data-rule-required='true'
													id='deposit' name='deposit' placeholder='Please input deposit'
													type='text' />
											</div>
										</div>
	...
	<script> 
            var tishi ='<%=request.getParameter("tishi")%>';
            if(tishi=='no'){
             alert("Rule_ID already exists!");
            }
   </script>
	<script> 
            var tishi ='<%=request.getParameter("tishi")%>';
