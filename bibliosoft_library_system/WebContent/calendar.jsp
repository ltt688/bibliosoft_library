		...
		<div class='navbar'>
			<div class='navbar-inner'>
				<div class='container-fluid'>
					<a class='brand' href='calendar.jsp'> <!--<i class='icon-heart-empty'></i>-->
					<img alt='logo' height='30' src='assets/images/logo2.png' width='30' />
					...
					<ul class='nav pull-right'>
						...
						<li class='dropdown dark user-menu'><a
							...
							<ul class='dropdown-menu'>
								...
								<li class='divider'></li>
								<li><a href=''> <i class='icon-signout'></i> Sign out
								</a></li>
							</ul></li>
					</ul>
		...
		<nav class='' id='main-nav'>
			<div class='navigation'>
				...
				<ul class='nav nav-stacked'>
					<li class='active'><a href='calendar.jsp'> <i
							...
							<div class='span12'>
								<div class='page-header'>
									...
									<div class='pull-right'>
										<ul class='breadcrumb'>
											<li><a href="calender.jsp"><i class='icon-bar-chart'></i>
											</a></li>
						...
						<div class='row-fluid'>
							<div class='span3 box' id='events'>
								...
								<div class='box-content'>
									<div class='label label-important external-event'>Jane
										meetup</div>
									<div class='label label-warning external-event'>Shopping</div>
									<div class='label label-success external-event'>Dentist</div>
									<hr class='hr-normal' />
									<label class='checkbox'> <input
										id='calendar-remove-after-drop' type='checkbox'
										value='option1' /> Remove after drop?
									</label>
									<hr class='hr-normal' />
									<form accept-charset="UTF-8" action="#" id="new-event"
									...
									<input class='input-block-level' id='new-event-input'
										placeholder='Type event' type='text' />
