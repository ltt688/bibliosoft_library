							...
							<div class='span12 box'>
								...
								<% Librarian librarian=(Librarian)request.getAttribute("librarian");%>
									<div class='control-group'>
										<label class='control-label' for='validation_name'>Password</label>
										<div class='controls'>
											<input data-rule-minlength='2' data-rule-required='true'
												id='password' name='password' placeholder='Please input name'
												type='text' value="<% out.println(librarian.getManager_password()); %>" readonly="readonly" />
										</div>
									</div>
		
								<div class='form-actions' style='margin-bottom: 0'>
								<a href='Retrive_Password.jsp'>
										<button class='btn btn-primary' type='submit'>
											<i class='icon-save'></i> Back
										</button>
										</a>
									</div>
